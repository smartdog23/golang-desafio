...
var file_user_message_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x19, 0x73, 0x6d, 0x61, 0x72, 0x74, 0x64, 0x6f, 0x67, 0x32, 0x33,
	0x2e, 0x64, 0x65, 0x73, 0x61, 0x66, 0x69, 0x6f, 0x2e, 0x67, 0x6f, 0x6c, 0x61, 0x6e, 0x67, 0x22,
	0x53, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0x6e, 0x0a, 0x0b, 0x55, 0x73,
	0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x5f, 0x0a, 0x0a, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x26, 0x2e, 0x73, 0x6d, 0x61, 0x72, 0x74, 0x64,
	0x6f, 0x67, 0x32, 0x33, 0x2e, 0x64, 0x65, 0x73, 0x61, 0x66, 0x69, 0x6f, 0x2e, 0x67, 0x6f, 0x6c,
	0x61, 0x6e, 0x67, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x27, 0x2e, 0x73, 0x6d, 0x61, 0x72, 0x74, 0x64, 0x6f, 0x67, 0x32, 0x33, 0x2e, 0x64, 0x65, 0x73,
	0x61, 0x66, 0x69, 0x6f, 0x2e, 0x67, 0x6f, 0x6c, 0x61, 0x6e, 0x67, 0x2e, 0x55, 0x73, 0x65, 0x72,
...
var file_user_message_proto_goTypes = []interface{}{
	(*UserRequest)(nil),  // 0: smartdog23.desafio.golang.UserRequest
	(*UserResponse)(nil), // 1: smartdog23.desafio.golang.UserResponse
}
var file_user_message_proto_depIdxs = []int32{
	0, // 0: smartdog23.desafio.golang.UserService.CreateUser:input_type -> smartdog23.desafio.golang.UserRequest
	1, // 1: smartdog23.desafio.golang.UserService.CreateUser:output_type -> smartdog23.desafio.golang.UserResponse
...
func (c *userServiceClient) CreateUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/smartdog23.desafio.golang.UserService/CreateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/smartdog23.desafio.golang.UserService/CreateUser",
	}
...
var _UserService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "smartdog23.desafio.golang.UserService",
